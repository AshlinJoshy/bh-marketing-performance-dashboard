...
// Route-level error boundary for /company — if the server render throws, show a
    ...
    <>
      ...
      <div className="chart-card">
        <div className="empty-state" style={{ height: "auto", padding: "30px 20px", display: "block", textAlign: "center" }}>
          <div style={{ fontWeight: 600, color: "var(--dark)", marginBottom: 8 }}>Couldn&apos;t load Company Performance</div>
